...
export default function DisplayForecast() {
  return (
    <section className="shadow-2xl shadow-gray-400 border-1 border-gray-200 dark:text-white dark:bg-[#0d1322] dark:shadow-none dark:border-gray-800 w-1/2 rounded-2xl px-4 py-6">
